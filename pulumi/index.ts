...
const instance = new aws.ec2.Instance("instance", {
    ...
    apt-get update
    apt-get install -y php8.2-cli php8.2-xml php8.2-curl php8.2-mbstring php8.2-zip php8.2-bcmath unzip
    php -r "copy('https://getcomposer.org/installer', 'composer-setup.php');"
    php composer-setup.php --install-dir=/usr/local/bin --filename=composer
    rm composer-setup.php
    sudo -u ubuntu git clone https://github.com/alaress/R2-bug-poc.git /home/ubuntu/R2-bug-poc
    cd /home/ubuntu/R2-bug-poc
